...
public class ContainerSetup {
    ...
    private static final String DB_NAME = "catalog-test";
    ...
    private static final String PORT_BINDING = "15433:5432";
    ...
    public void setup() throws LiquibaseException {
        jdbcTemplate.execute("DROP TYPE IF EXISTS category_type CASCADE");
